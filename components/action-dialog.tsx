            ...
            <Dialog>
                ...
                <DialogContent>
                    <div className='flex flex-col items-center justify-center py-6'>
                        ...
                        <span className='text-xl text-black'>Confirm</span>
                        <p className='text-sm'>
                            Are you sure you want to delete record? This process is irreversible.
                        </p>
            ...
            <Dialog>
                ...
                <DialogContent className='max-w-[300px] md:max-w-2xl max-h-[90%] p-8 overflow-y-auto'>
                    ...
                    <div className='flex justify-between'>
                        <div className='flex gap-3 items-center'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <span className='text-gray-800 text-sm md:text-base capitalize'>
                    ...
                    <div className='mt-10 space-y-6'>
                        ...
                        xl:justify-between gap-y-4 md:gap-x-0'>
                        ...
                        <div>
                            <SmallCard label="Hospital" value={data?.address} />
                        </div>
