...
export const ProfileImage = ({
    url, name, className, textClassName, bgColor,
} : {
    url: string;
    name: string;
    className?: string;
    ...
    if (name) {
        return (
            <div
                className={cn("flex md:hidden lg:flex w-10 h-10 rounded-full text-white text-base items-center justify-center font-light",
                    className
                )}
