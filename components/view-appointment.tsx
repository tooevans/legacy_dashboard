            ...
            <DialogContent className='max-w-106.25 max-h-[95%] md:max-w-2xl 2xl:max-w-3xl p-8 overflow-y-auto'>
                <>
                    ...
                    {data?.status === "CANCELLED" && (
                        <div className='bg-yellow-100 mt-4 p-4 rounded-md'>
                            <span className='font-semibold text-sm'>Appointment cancelled</span>
                            <p className='text-sm'>
                    ...
                    <div className='grid gap-4 py-4'>
                        ...
                        <div className='flex flex-col md:flex-row gap-6 mb-16'>
                            <div className='flex gap-1 w-full md:w-1/2'>
                                ...
                                <div className='space-y-0.5'>
                                    ...
                                    <span className='f;ex items-center text-sm gap-2'>
                        ...
                        <div className='w-full flex flex-col md:flex-row gap-8 mb-8'>
                            <div className='flex gap-3'>
                                <ProfileImage
                                    ...
                                    className='xl:size-20 bg-teal-400'
                        ...
                        {(await checkRole("ADMIN") || data?.doctor_id === userId) && (
                            <>
                                <p className='w-fit bg-blue-100 text-blue-500 rounded text-xs md:text-sm mt-4'>
                                    Perform Action
                                </p>
