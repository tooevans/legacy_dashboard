/*
  ...
  - You are about to drop the column `id_number` on the `Patient` table. All the data in the column will be lost.
...
*/
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'NURSE', 'DOCTOR', 'PATIENT', 'PHARMACIST', 'LAB_TECHNICIAN');
...
-- AlterTable
ALTER TABLE "Patient" DROP COLUMN "id_number",
